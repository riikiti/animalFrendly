...
use App\Modules\Marketplace\Infrastructure\Persistence\Eloquent\Repositories\EloquentBreederRepository;
...
final class MarketplaceServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(BreederRepositoryInterface::class, EloquentBreederRepository::class);
    }
    ...
    public function boot(): void
    {
        ...
        Gate::define('verify-breeders', static fn (IdentityUser $user): bool => in_array(
            $user->account_type,
            ['admin', 'moderator'],
            true,
        ));
