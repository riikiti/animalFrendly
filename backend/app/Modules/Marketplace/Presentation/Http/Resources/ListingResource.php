 ...
 * seller_name?: ?string, seller_avatar_url?: ?string, seller_verified?: bool} — как
 * ShelterAnimalResource, см. Shelter\Presentation\Http\Resources\ShelterAnimalResource.
 * Опциональные ключи по умолчанию null/false для мест, где они ещё не подгружены.
 */
final class ListingResource extends JsonResource
{
    ...
    {
        /** @var array{listing: Listing, pet: ?Pet, parent_name?: ?string, seller_name?: ?string, seller_avatar_url?: ?string, seller_verified?: bool} $data */
        $data = $this->resource;
